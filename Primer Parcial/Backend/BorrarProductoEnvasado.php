<?php
    ...
    if(isset($_POST["producto_json"]))
    {
        ...
        {
            $ProductoEnvasado = new ProductoEnvasado($json["nombre"], $json["origen"], $json["codigoBarra"], $json["precio"], $json["id"], $json["pathFoto"]);
    ...
    {
        $json_data = file_get_contents('./archivos/productos_envasados_borrados.json');
